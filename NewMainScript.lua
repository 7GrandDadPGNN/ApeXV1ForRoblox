...
local Window = Library.CreateLib("ApeXV1", "DarkTheme")
...
MainSection:NewButton("Keyboard for phone", "idk why i put this", function()
...
MainSection:NewButton("Inf Jump", "wtf how it istnt patched", function()
...
MainSection:NewTextBox("speed (not work)", "not working now", function(txt)
	game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = txt
end)

-- Utility
local Cool = Window:NewTab("Utility")
local CoolSection = Cool:NewSection("FE Animations")
...
CoolSection:NewButton("Rainbow cape(actualy not working)", "", function()
...
MainSection:NewLabel("Script Loaders")

MainSection:NewButton("Vape loader for phone", "", function()
...
MainSection:NewButton("cooming soon", "", function()
    loadstring(game:HttpGet("coming soon", true))()
end)

MainSection:NewButton("coming soon", "", function()
